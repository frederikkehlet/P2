...
for ($day = 1; $day <= $day_count; $day++, $str++) {
	...
	if ($today == $date) {
		$week .= '<td class="today"><button type="submit" value="submit" id="button"><a href="Bane_oversigt.php?ym='.$ym.'&date='.$date.'">'.sprintf("%02d", $day);
	} else {
		$week .= '<td><button type="submit" value="submit" id="button"><a href="Bane_oversigt.php?ym='.$ym.'&date='.$date.'">'.sprintf("%02d", $day);
	}
	$week .= '</a></button></td>';
	...
	<body>
		<div class="header">
			<div class="wrapper">
				...
				<div class="button">
					<button class="disabled" onclick="window.location.href='http://localhost/P2kode/Bane_oversigt.php'" style="background-color: #BF0D0D; border: 3px solid white; color:white; text-decoration: underline;">Bane oversigt</button>

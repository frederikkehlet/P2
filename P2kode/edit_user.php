...
<html>
	...
	<div class="header"><!-- header -->
		...
		<div>
			<a href="Min_side.php" style="float:left;margin-left: 5%;color:#bf0d0d;">< Gå tilbage til kontaktoplysninger</a>
		</div>
		<form action="update.php" method="GET" style="border:none;margin-top: 100px;margin-left:50%;">
			<tabel>
				...
				<tr>
					<th>Fornavn</th>
					<td>
						<input type="text" name="first_name" value="<?php echo $row[0]; ?>">
					</td>
				</tr>
				<tr>
					<th>Efternavn</th>
					<td>
						<input type="text" name="last_name" value="<?php echo $row[1]; ?>">
					</td>
				</tr>
				<tr>
					<th>Email</th>
				...
				<tr>
					<th>Tlf nummer</th>
					<td>
						<input type="text" name="number" minlength="8" maxlength="8" value="<?php echo $row[4]; ?>">
					</td>
				</tr>
				<tr>
					<th>Klub</th>
